...
export async function transferLLG(params = { body, config }) {
  const body = {
    ...
    'beneficiaryType': params.body.beneficiaryType,
  ...
  const res = await httpClient.requestBniDirectV2({
    ...
    url: `${params.config.client.getBaseUrl()}/bnidirect/api/LLG/Transfer`,
