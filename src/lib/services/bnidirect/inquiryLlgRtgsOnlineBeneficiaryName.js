...
export async function inquiryLlgRtgsOnlineBeneficiaryName(params = { body, config }) {
  const body = {
  ...
  const res = await httpClient.requestBniDirectV2({
    ...
    url: `${params.config.client.getBaseUrl()}/bnidirect/api/Online/InquiryBeneficiaryName`,
