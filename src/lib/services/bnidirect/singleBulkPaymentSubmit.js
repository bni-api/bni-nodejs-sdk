...
export async function singleBulkPaymentSubmit(params = { body, config }) {
  const body = {
  ...
  const res = await httpClient.requestBniDirectV2({
    ...
    url: `${params.config.client.getBaseUrl()}/bnidirect/api/MassPayment/SingleBulkPaymentMixed/Submit`,
