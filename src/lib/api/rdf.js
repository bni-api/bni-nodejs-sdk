...
import { responseRDF } from '../util/response.js';
...
class RDF {
  ...
  async registerInvestor(
    ...
    const signature = generateSignature({
      body: { request: { ...body }, timestamp: this.timeStamp },
  ...
  async registerInvestorAccount(
    ...
    const res = await this.httpClient.requestV2({
      ...
      apiKey: this.config.apiKey,
      accessToken: await this.client.getToken(),
      url: `${this.client.getBaseUrl()}/rdf/v2.1/register/investor/account`,
      signature: signature.split('.')[2],
      timestamp: this.timeStamp,
      data: { request: { ...body } }
    });
  ...
  async inquiryAccountInfo(
    ...
    const res = await this.httpClient.requestV2({
      ...
      apiKey: this.config.apiKey,
      accessToken: await this.client.getToken(),
      url: `${this.client.getBaseUrl()}/rdf/v2.1/inquiry/account/info`,
      signature: signature.split('.')[2],
      timestamp: this.timeStamp,
      data: { request: { ...body } }
    });
  ...
  async inquiryAccountBalance(
    ...
    const res = await this.httpClient.requestV2({
      ...
      apiKey: this.config.apiKey,
      accessToken: await this.client.getToken(),
      url: `${this.client.getBaseUrl()}/rdf/v2.1/inquiry/account/balance`,
      signature: signature.split('.')[2],
      timestamp: this.timeStamp,
      data: { request: { ...body } }
    });
  ...
  async inquiryAccountHistory(
    ...
    const res = await this.httpClient.requestV2({
      ...
      apiKey: this.config.apiKey,
      accessToken: await this.client.getToken(),
      url: `${this.client.getBaseUrl()}/rdf/v2.1/inquiry/account/history`,
      signature: signature.split('.')[2],
      timestamp: this.timeStamp,
      data: { request: { ...body } }
    });
  ...
  async paymentUsingTransfer(
    ...
    const res = await this.httpClient.requestV2({
      ...
      apiKey: this.config.apiKey,
      accessToken: await this.client.getToken(),
      url: `${this.client.getBaseUrl()}/rdf/v2.1/payment/transfer`,
      signature: signature.split('.')[2],
      timestamp: this.timeStamp,
      data: { request: { ...body } }
    });
  ...
  async inquiryPaymentStatus(
    ...
    const res = await this.httpClient.requestV2({
      ...
      apiKey: this.config.apiKey,
      accessToken: await this.client.getToken(),
      url: `${this.client.getBaseUrl()}/rdf/v2.1/inquiry/payment/status`,
      signature: signature.split('.')[2],
      timestamp: this.timeStamp,
      data: { request: { ...body } }
    });
  ...
  async paymentUsingClearing(
    ...
    const res = await this.httpClient.requestV2({
      ...
      apiKey: this.config.apiKey,
      accessToken: await this.client.getToken(),
      url: `${this.client.getBaseUrl()}/rdf/v2.1/payment/clearing`,
      signature: signature.split('.')[2],
      timestamp: this.timeStamp,
      data: { request: { ...body } }
    });
  ...
  async paymentUsingRTGS(
    ...
    const res = await this.httpClient.requestV2({
      ...
      apiKey: this.config.apiKey,
      accessToken: await this.client.getToken(),
      url: `${this.client.getBaseUrl()}/rdf/v2.1/payment/rtgs`,
      signature: signature.split('.')[2],
      timestamp: this.timeStamp,
      data: { request: { ...body } }
    });
  ...
  async inquiryInterbankAccount(
    ...
    const res = await this.httpClient.requestV2({
      ...
      apiKey: this.config.apiKey,
      accessToken: await this.client.getToken(),
      url: `${this.client.getBaseUrl()}/rdf/v2.1/inquiry/interbank/account`,
      signature: signature.split('.')[2],
      timestamp: this.timeStamp,
      data: { request: { ...body } }
    });
  ...
  async paymentUsingInterbank(
    ...
    const res = await this.httpClient.requestV2({
      ...
      apiKey: this.config.apiKey,
      accessToken: await this.client.getToken(),
      url: `${this.client.getBaseUrl()}/rdf/v2.1/payment/interbank`,
      signature: signature.split('.')[2],
      timestamp: this.timeStamp,
      data: { request: { ...body } }
    });
